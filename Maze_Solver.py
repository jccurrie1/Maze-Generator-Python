...
parser.add_argument("--world_file", type=str, default="test.dat?python Maze_Solver.py --world_file=test.dat", help="World file in the worlds folder to use.")
